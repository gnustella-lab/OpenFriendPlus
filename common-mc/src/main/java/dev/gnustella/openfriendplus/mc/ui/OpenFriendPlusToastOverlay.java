...
public final class OpenFriendPlusToastOverlay {
    ...
    private OpenFriendPlusToastOverlay() {}
    ...
    public static void push(NoticeSink.Level level, String title, String body) {
        ...
        if (!firstPushLogged) {
            ...
            org.slf4j.LoggerFactory.getLogger("openfriendplus").info("OpenFriendPlusToastOverlay.push fired: level={} title={} (entries={}, renderCalls={})",
    ...
    public static void render(GuiGraphics g, int screenWidth) {
        ...
        if (!firstRenderLogged) {
            ...
            org.slf4j.LoggerFactory.getLogger("openfriendplus").info("OpenFriendPlusToastOverlay.render first call: screenWidth={} entries={}",
